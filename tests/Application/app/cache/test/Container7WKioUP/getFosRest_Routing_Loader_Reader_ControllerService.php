...
return $this->privates['fos_rest.routing.loader.reader.controller'] = new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(($this->privates['fos_rest.routing.loader.reader.action'] ?? $this->load('getFosRest_Routing_Loader_Reader_ActionService.php')), ($this->privates['annotations.cached_reader'] ?? $this->load('getAnnotations_CachedReaderService.php')));
