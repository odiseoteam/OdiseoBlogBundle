 ...
 */
class ArticleTranslation extends \Odiseo\BlogBundle\Model\ArticleTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'slug', 'title', 'content', 'metaKeywords', 'metaDescription', 'locale', 'translatable'];
        }
